    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 18, position: 'relative' }}>
          <div style={{
            ...
            <span style={{
              ...
              height: 3, background: 'var(--ir-orange)',
            }} />
          </div>
          <div>
            <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <p style={{
            fontFamily: 'var(--font-rajdhani)',
            fontSize: 18, color: 'var(--ir-text-muted)',
          ...
          <div style={{
            ...
            <span style={{ width: 6, height: 6, background: 'var(--ir-orange)', borderRadius: '50%', display: 'block' }} />
        ...
        <div style={{
          ...
          {[
            ...
            <span key={label}>
              {label}
              <strong style={{ display: 'block', color: 'var(--ir-text-muted)', fontWeight: 500, marginTop: 4 }}>
                {value}
              </strong>
            </span>
          ))}
      ...
      <div style={{
        ...
        <form onSubmit={submit} style={{
          ...
          <span style={{
            ...
            height: 2,
            background: 'linear-gradient(90deg, transparent, var(--ir-blue) 30%, var(--ir-orange) 70%, transparent)',
          }} />

          <h2 style={{
            fontFamily: 'var(--font-rajdhani)',
            fontWeight: 700, fontSize: 22,
            letterSpacing: 5, margin: '0 0 4px',
          }}>OPERATOR LOGIN</h2>
          <div style={{
            fontFamily: 'var(--font-mono)',
          ...
          {/* Fields */}
          {[
            { label: 'OPERATOR ID', type: 'text', value: user, onChange: setUser, placeholder: 'enter operator id' },
